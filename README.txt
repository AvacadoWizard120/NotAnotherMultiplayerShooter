# Not Another Multiplayer Shooter

This is the readme for Not Another Multiplayer Shooter, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. NotAnotherMultiplayerShooter) > Ok.
...
- To run the project find NotAnotherMultiplayerShooter.java (which will be in under src/main/java/io/github/avacadowizard/notanothermultiplayershooter) and right click > Run 'NotAnotherMultiplayerShooter'
